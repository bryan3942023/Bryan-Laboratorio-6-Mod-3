...
class CucumberJSAllureFormatter extends cucumber_1.Formatter {
    ...
    onTestCaseStarted(data) {
        ...
        if ((_d = pickle.tags) === null || _d === void 0 ? void 0 : _d.length) {
        ...
        if (!((_e = scenario === null || scenario === void 0 ? void 0 : scenario.examples) === null || _e === void 0 ? void 0 : _e.length)) {
            return;
        }
    ...
    handleAllureAttachment(payload) {
        const { labels = [], links = [], parameter = [], steps = [], description, descriptionHtml, } = payload.metadata;
        ...
        parameter.forEach(({ name, value, excluded, mode }) => payload.test.addParameter(name, value, {
            excluded,
            mode,
        }));
        steps.forEach((step) => {
    ...
    handleAllureStep(payload) {
        const step = allure_js_commons_1.AllureCommandStepExecutable.toExecutableItem(this.allureRuntime, payload.stepMetadata);
        if (payload.step) {
